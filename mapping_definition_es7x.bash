...
# Create the Index : tags
print_help "index" "tags"
curl -XPUT 'http://localhost:9200/tags'
# Elasticsearch 7.5.2
# string is obsolete
print_help "mapping" "tags"
curl -H 'Content-Type: application/json' -XPUT 'http://localhost:9200/tags/_mapping/tag?include_type_name=true' -d'
{
  "tag" : {
    "properties" : {
      "name"  : { "type" : "text"},
...
curl -H 'Content-Type: application/json' -XPUT 'http://localhost:9200/properties/_mapping/property?include_type_name=true' -d'
{
  "property" : {
    "properties" : {
      "name"  : { "type" : "text" },
...
curl -H 'Content-Type: application/json' -XPUT 'http://localhost:9200/channelfinder/_mapping/channel?include_type_name=true' -d'
{
  "channel" : {
    "properties" : {
      "name" : {
